...
const Contact = ({
  ...
  address = process.env.NEXT_PUBLIC_MAP_EMBED_QUERY || "",
  mapsShareUrl = process.env.NEXT_PUBLIC_MAPS_SHARE_URL || "",
  mapEmbedQuery = process.env.NEXT_PUBLIC_MAP_EMBED_QUERY || "",
}) => {
